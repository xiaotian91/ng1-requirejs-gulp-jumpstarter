define(['./app'], function(app) {
	app.filter('commaGroups', function() { // angular filter, to be used with the "ngFilter" option in column definitions below
	...
	app.controller('apMesaDemoCtrl', ['$scope', '$templateCache', '$q', function($scope, $templateCache, $q) {
